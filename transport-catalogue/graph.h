...
namespace graph {
    ...
    public:
        ...
        // доступ к внутренним данным графа для "ручного" заполнения
    ...
    template<typename Weight>
    std::vector<typename DirectedWeightedGraph<Weight>::IncidenceList>&
        DirectedWeightedGraph<Weight>::GetIncidenceLists() {
